<div class="d-flex">
    ...
    type="text" placeholder="Enter Registered User to Become Viewer"
    class="search-lw">
    ...
    <button wire:click="madeViewer" class="search-lw-button" @if (!$ifRegistered) disabled @endif>Become Viewer</button>
</div>
